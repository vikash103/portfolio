...
<body class="text-white">
    ...
    <!-- Journey Timeline -->
    <section id="journey" class="py-24 bg-slate-950/50">
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            <div class="text-center mb-16" data-aos="fade-up"><h2 class="text-4xl font-bold">My <span class="text-blue-400">Professional Journey</span></h2><div class="w-24 h-1 bg-blue-500 mx-auto mt-4 rounded-full"></div><p class="text-gray-400 mt-4 max-w-2xl mx-auto">From intern to Laravel developer – a story of continuous learning and building impactful solutions.</p></div>
            <div class="relative"><div class="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-full bg-blue-500/30 hidden md:block"></div>
                <div class="relative mb-12 md:mb-16" data-aos="fade-right"><div class="md:flex items-center"><div class="md:w-1/2 md:pr-12 text-right hidden md:block"><span class="text-blue-400 font-bold">Aug 2025 – Present</span></div><div class="md:w-1/2 md:pl-12"><div class="glass-card p-6 rounded-2xl ml-4 md:ml-0 relative"><div class="absolute -left-3 top-6 w-4 h-4 rounded-full bg-blue-500 timeline-dot hidden md:block"></div><h3 class="text-xl font-bold">PHP Developer</h3><p class="text-blue-300 text-sm">Saman Technosys Pvt. Ltd.</p><p class="text-gray-400 text-sm mt-2">Developing web apps with PHP & Laravel, building RESTful APIs, optimizing databases, and collaborating with frontend teams.</p></div></div></div></div>
                <div class="relative mb-12 md:mb-16" data-aos="fade-left"><div class="md:flex items-center flex-row-reverse"><div class="md:w-1/2 md:pl-12 text-left hidden md:block"><span class="text-blue-400 font-bold">Jan 2025 – Apr 2025</span></div><div class="md:w-1/2 md:pr-12"><div class="glass-card p-6 rounded-2xl mr-4 md:mr-0 relative"><div class="absolute -right-3 top-6 w-4 h-4 rounded-full bg-blue-500 timeline-dot hidden md:block"></div><h3 class="text-xl font-bold">Laravel Developer</h3><p class="text-blue-300 text-sm">SME Consulting Services</p><p class="text-gray-400 text-sm mt-2">Built REST APIs, authentication, optimized MySQL queries, and enhanced performance.</p></div></div></div></div>
                <div class="relative mb-12" data-aos="fade-right"><div class="md:flex items-center"><div class="md:w-1/2 md:pr-12 text-right hidden md:block"><span class="text-blue-400 font-bold">Jul 2024 – Sep 2024</span></div><div class="md:w-1/2 md:pl-12"><div class="glass-card p-6 rounded-2xl ml-4 md:ml-0 relative"><div class="absolute -left-3 top-6 w-4 h-4 rounded-full bg-blue-500 timeline-dot hidden md:block"></div><h3 class="text-xl font-bold">.NET Developer Intern</h3><p class="text-blue-300 text-sm">ISA ERP Solutions Pvt. Ltd.</p><p class="text-gray-400 text-sm mt-2">Worked on ASP.NET Core, SQL Server, and ERP system enhancements.</p></div></div></div></div>
            </div>
        </div>
    </section>

    <!-- Projects Section -->
    <section id="projects" class="py-24 bg-slate-900/40">
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            <div class="text-center mb-14" data-aos="fade-up">
                <h2 class="text-4xl font-bold">Featured <span class="text-blue-400">Projects</span></h2>
                <p class="text-gray-400 mt-3">Real-world solutions I've crafted with Laravel & PHP</p>
            </div>
            <div class="grid md:grid-cols-2 gap-8">
                <!-- Project 1: Patient Management System -->
                <div class="glass-card rounded-2xl overflow-hidden group" data-aos="flip-left">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold mb-2">Patient Management System</h3>
                        <p class="text-gray-300">CRUD operations, role-based access (RBAC), normalized MySQL schema, pagination, validation, API integration, query optimization with indexing.</p>
                        ...
                        <div class="flex gap-3 mt-5">
                            <a href="#" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600/20 border border-blue-500 text-blue-300 text-sm font-medium hover:bg-blue-600 hover:text-white transition-all duration-300">
                                <i class="fas fa-external-link-alt text-xs"></i> Live Demo
                            </a>
                            <a href="#" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-800/80 border border-gray-700 text-gray-300 text-sm font-medium hover:bg-slate-700 hover:text-white transition-all duration-300">
                ...
                <div class="glass-card rounded-2xl overflow-hidden group" data-aos="flip-right">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold mb-2">Hotel Management System</h3>
                        <p class="text-gray-300">Built with Django, booking system, relational database design, business logic implementation, and admin dashboard.</p>
                        <div class="flex flex-wrap gap-2 mt-4">
                ...
                <!-- New Project 3: Admin Panel System -->
                <div class="glass-card rounded-2xl overflow-hidden group" data-aos="flip-left">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold mb-2">Admin Panel System</h3>
                        <p class="text-gray-300">Developed a full-featured admin panel using Laravel, React.js, and Tailwind CSS. Implemented authentication, role-based access control, and dashboard analytics.</p>
                        <div class="flex flex-wrap gap-2 mt-4">
                            <span class="text-xs bg-slate-800 px-3 py-1 rounded-full">Laravel</span>
                ...
                <!-- New Project 4: User Registration Notification System -->
                <div class="glass-card rounded-2xl overflow-hidden group" data-aos="flip-right">
                    ...
                    <div class="p-6">
                        <h3 class="text-2xl font-bold mb-2">User Registration Notification System</h3>
                        <p class="text-gray-300">Implemented a notification system that sends automated WhatsApp and email messages when a user registers. Integrated APIs and used Laravel queue system to handle background jobs efficiently and ensure reliable message delivery.</p>
                        <div class="flex flex-wrap gap-2 mt-4">
                            <span class="text-xs bg-slate-800 px-3 py-1 rounded-full">Laravel</span>
    ...
    <!-- Skills Section -->
    <section id="skills" class="py-24 bg-slate-950/50">
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            <div class="text-center mb-12" data-aos="fade-up"><h2 class="text-4xl font-bold">Technical <span class="text-blue-400">Expertise</span></h2><div class="w-20 h-1 bg-blue-500 mx-auto mt-4 rounded-full"></div></div>
            <div class="grid md:grid-cols-2 gap-12">
                <div data-aos="fade-right"><h3 class="text-xl font-semibold mb-4">Backend & Databases</h3><div class="space-y-4"><div><div class="flex justify-between"><span>PHP (7.4/8.x)</span><span>90%</span></div><div class="skill-bar"><div class="skill-progress" data-width="90"></div></div></div><div><div class="flex justify-between"><span>Laravel (8/9)</span><span>88%</span></div><div class="skill-bar"><div class="skill-progress" data-width="88"></div></div></div><div><div class="flex justify-between"><span>MySQL / PostgreSQL</span><span>85%</span></div><div class="skill-bar"><div class="skill-progress" data-width="85"></div></div></div><div><div class="flex justify-between"><span>RESTful APIs</span><span>90%</span></div><div class="skill-bar"><div class="skill-progress" data-width="90"></div></div></div></div></div>
                <div data-aos="fade-left"><h3 class="text-xl font-semibold mb-4">Frontend & Tools</h3><div class="space-y-4"><div><div class="flex justify-between"><span>HTML5/CSS3/Tailwind</span><span>85%</span></div><div class="skill-bar"><div class="skill-progress" data-width="85"></div></div></div><div><div class="flex justify-between"><span>JavaScript/jQuery</span><span>75%</span></div><div class="skill-bar"><div class="skill-progress" data-width="75"></div></div></div><div><div class="flex justify-between"><span>Git & GitHub</span><span>80%</span></div><div class="skill-bar"><div class="skill-progress" data-width="80"></div></div></div><div><div class="flex justify-between"><span>Composer / Artisan</span><span>85%</span></div><div class="skill-bar"><div class="skill-progress" data-width="85"></div></div></div></div></div>
            </div>
        </div>
    </section>

    <!-- Contact Section with AJAX (No Page Reload) -->
    <section id="contact" class="py-24 bg-slate-900/60">
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            <div class="text-center mb-12" data-aos="fade-up">
                <h2 class="text-4xl font-bold">Let's <span class="text-blue-400">Connect</span></h2>
                <p class="text-gray-400 mt-2">Have a project? Let's build something great together.</p>
            </div>
            <div class="max-w-4xl mx-auto glass rounded-2xl p-8 md:p-10" data-aos="zoom-in">
                <div class="grid md:grid-cols-2 gap-8">
                    <div>
                        <h3 class="text-2xl font-semibold mb-4">Contact Info</h3>
                        <div class="space-y-4">
                            <div class="flex items-center gap-3"><i class="fas fa-map-marker-alt text-blue-400 w-5"></i><span>Mumbai, Maharashtra, India – 400091</span></div>
                            <div class="flex items-center gap-3"><i class="fas fa-phone-alt text-blue-400 w-5"></i><span>+91 8873463079</span></div>
                            <div class="flex items-center gap-3"><i class="fas fa-envelope text-blue-400 w-5"></i><span>vikashkumarmishramdnbn22@gmail.com</span></div>
                        </div>
                        <div class="mt-8">
                            <h3 class="text-xl font-semibold mb-2">Education</h3>
                            <p class="text-gray-300">BCA, Ravindranath Tagore University (2023) – CGPA: 7.8</p>
                            <p class="text-gray-400 text-sm mt-1">Full-Stack Web Development Certification (Udemy)</p>
                        </div>
                    </div>
                    <div>
                        ...
                        <form id="ajaxContactForm">
                            @csrf
                            <div class="mb-4">
                                <input type="text" name="name" id="ajax_name" placeholder="Full Name" required class="w-full bg-slate-800 border border-gray-700 rounded-xl p-3 focus:outline-none focus:border-blue-500">
                            </div>
                            <div class="mb-4">
                                <input type="email" name="email" id="ajax_email" placeholder="Email Address" required class="w-full bg-slate-800 border border-gray-700 rounded-xl p-3 focus:outline-none focus:border-blue-500">
                            </div>
                            <div class="mb-4">
                                <input type="text" name="subject" id="ajax_subject" placeholder="Subject" class="w-full bg-slate-800 border border-gray-700 rounded-xl p-3 focus:outline-none focus:border-blue-500">
                            </div>
                            <div class="mb-4">
                                <textarea name="message" id="ajax_message" rows="4" placeholder="Your Message" required class="w-full bg-slate-800 border border-gray-700 rounded-xl p-3 focus:outline-none focus:border-blue-500"></textarea>
                            </div>
                            <button type="submit" id="ajaxSubmitBtn" class="w-full bg-blue-600 hover:bg-blue-500 py-3 rounded-xl font-semibold transition flex items-center justify-center gap-2">
                                <i class="fas fa-paper-plane"></i> Send Message
                            </button>
                            <div id="ajaxFormMessage" class="text-center text-sm mt-4 hidden"></div>
                        </form>
                    </div>
                </div>
            </div>
