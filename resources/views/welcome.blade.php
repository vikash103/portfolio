    ...
    <section id="home" class="min-h-screen flex items-center justify-center relative pt-20 pb-12 overflow-hidden">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-12 lg:gap-16">
                ...
                <!-- Right Content - Profile Image (appears second on mobile, properly centered with no bottom gap) -->
                <div data-aos="zoom-in" class="relative flex-shrink-0 flex items-center justify-center w-full lg:w-1/2 mt-6 lg:mt-0">
                    <!-- Circular container with no bottom gap -->
                    <div class="w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96 rounded-full bg-gradient-to-tr from-blue-500 via-indigo-500 to-purple-500 p-[4px] sm:p-[5px] md:p-[6px] shadow-[0_0_30px_rgba(59,130,246,0.4)] transition-all duration-500 hover:scale-105 mx-auto flex items-center justify-center">
                        <div class="w-full h-full rounded-full overflow-hidden bg-slate-900 flex items-center justify-center">
                            <img src="{{ asset('image.png') }}" alt="Vikash Mishra" class="block w-full h-full object-cover object-[center_25%] scale-110">
                        </div>
                    </div>
